...
class DynamicalContrastiveLoss(torch.nn.Module):
    """
    Contrastive regulariser on the channel-attention scores: it pulls similar
    channels together and pushes dissimilar ones apart, so the learned mask
    reflects channel correlation rather than collapsing to a constant.
    """
